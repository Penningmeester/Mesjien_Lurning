...
window_sizes = [int(float(250)/milliseconds_per_instance), int(float(0.5*60000)/milliseconds_per_instance), int(float(5*60000)/milliseconds_per_instance)]
...
skip_points2 = int((1-window_overlap2) * ws)
dataset = dataset.iloc[::skip_points,:]
dataset2 = dataset.iloc[::skip_points2,:]


dataset.to_csv(dataset_path + 'chapter4_result1.csv')
dataset2.to_csv(dataset_path + 'chapter4_result2.csv')
...
DataViz.plot_dataset(dataset2, ['acc_phone_x', 'gyr_phone_x', 'mag_phone_x', 'pca_1', 'label'], ['like', 'like', 'like', 'like','like'], [ 'line', 'line', 'line', 'line', 'points'])
