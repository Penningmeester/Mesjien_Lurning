...
dataset['Activity_level'] = 0
dataset.loc[dataset.labelRunning==1,'Activity_level']=1
dataset.loc[dataset.labelDriving==1,'Activity_level']=0.25
dataset.loc[dataset.labelEating==1,'Activity_level']=0.15
dataset.loc[dataset.labelOnTable==1,'Activity_level']=0.05
dataset.loc[dataset.labelSitting==1,'Activity_level']=0.05
dataset.loc[dataset.labelStanding==1,'Activity_level']=0.1
dataset.loc[dataset.labelWalking==1,'Activity_level']=0.4
dataset.loc[dataset.labelWashingHands==1,'Activity_level']=0.15
