...
dataset_path = '../datasets/crowdsignals.io/own-set/'
...
datasets[0].to_csv(result_dataset_path + 'chapter2_result_%s.csv'%granularities[0])
datasets[1].to_csv(result_dataset_path + 'chapter2_result_%s.csv'%granularities[1])
